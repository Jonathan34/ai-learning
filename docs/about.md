...
This is a structured learning path for experienced software engineers who want to become credible in applied AI and agentic systems. It's not an ML course — it assumes you know distributed systems, cloud, and production operations, and fills in the AI-specific gaps.

The content is opinionated and honest about what's settled vs. still evolving. It's written for peers, not beginners.
